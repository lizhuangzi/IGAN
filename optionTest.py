...
parser.add_argument('--n_GPUs', type=int, default=1,
                    help='number of GPUs')
parser.add_argument('--GPU_id', type=str, default="1", choices=['0',"1",'2','3'],
...
# Model specifications IGANFeaOut
parser.add_argument('--model', default='IGAN',
                    help='model name')

parser.add_argument('--act', type=str, default='relu',
                    help='activation function')
parser.add_argument('--pre_train', type=str, default='./savedModel/IGANX4.parm',
...
# options for test
parser.add_argument('--testpath', type=str, default='./TestDir',
